...
public class ListTester {
	...
	private void runTests() {
		...
		//1-element to empty list via iterator remove after next
		testEmptyList(A_iterRemoveAfterNextA_emptyList,"A_iterRemoveAfterNextA_emptyList");

		// ************Testing for 1 element lists************
		...
		//empty to 1-element list via add(A)
		...
		//1-element to 2-element via add(B) 
	...
	//*********************Scenarios resulting in empty Lists*********************
...
//			break;
	...
	//*********************Scenarios resulting in 1-element Lists*********************
	...
	/** Scenario: [A,B] -> iteratorRemoveAfter2xNextB -> [A]
	 * @return [A] after iteratorRemoveAfter2xNextB
	 */
	...
	//*********************Scenarios resulting in 2-element Lists*********************
	 ...
	 * @return [B,C] after iteratorRemoveAfter2xNextB
	 */
	...
	/** Scenario: [A,B,C] -> iteratorRemoveAfter2xNextB -> [A,C]
	 * @return [A,C] after iteratorRemoveAfter2xNextB
	 */
	...
	/** Scenario: [A,B,C] -> iteratorRemoveAfter3xNextC -> [A,B]
	 * @return [A,B] after iteratorRemoveAfter3xNextC
	 */
	...
	//*********************Scenarios resulting in 3-element Lists*********************
	...
	private void testTwoElementList(Scenario<Integer> scenario, String scenarioName, Integer[] contents, String contentsString) {
		...
		try {
			...
			printTest(scenarioName + "_iter2xNext_testIterHasNext", testIterHasNext(iterAfterNext(scenario.build(), 2), Result.False));
			printTest(scenarioName + "_iter2xNext_testIterNext", testIterNext(iterAfterNext(scenario.build(), 2), null, Result.NoSuchElement));
			printTest(scenarioName + "_iter2xNext_testIterRemove", testIterRemove(iterAfterNext(scenario.build(), 2), Result.NoException));
			printTest(scenarioName + "_iter2xNextRemove_testIterRemove", testIterRemove(iterAfterRemove(iterAfterNext(scenario.build(), 2)), Result.IllegalState));
			printTest(scenarioName + "_iter2xNextRemove_testHasNext", testIterHasNext(iterAfterRemove(iterAfterNext(scenario.build(), 2)), Result.False));
			printTest(scenarioName + "_iter2xNextRemove_testNext", testIterNext(iterAfterRemove(iterAfterNext(scenario.build(), 2)), null, Result.NoSuchElement));
	...
	private void testThreeElementList(Scenario<Integer> scenario, String scenarioName, Integer[] contents, String contentsString) {
		...
		try {
			...
			printTest(scenarioName + "_iter2xNext_testIterHasNext", testIterHasNext(iterAfterNext(scenario.build(), 2), Result.True));
			printTest(scenarioName + "_iter2xNext_testIterNext", testIterNext(iterAfterNext(scenario.build(), 2), contents[2], Result.MatchingValue));
			printTest(scenarioName + "_iter2xNext_testIterRemove", testIterRemove(iterAfterNext(scenario.build(), 2), Result.NoException));
			printTest(scenarioName + "_iter2xNextRemove_testIterRemove", testIterRemove(iterAfterRemove(iterAfterNext(scenario.build(), 2)), Result.IllegalState));
			printTest(scenarioName + "_iter2xNextRemove_testHasNext", testIterHasNext(iterAfterRemove(iterAfterNext(scenario.build(), 2)), Result.True));
			printTest(scenarioName + "_iter2xNextRemove_testNext", testIterNext(iterAfterRemove(iterAfterNext(scenario.build(), 2)), contents[2], Result.MatchingValue));
				
			printTest(scenarioName + "_iter3xNext_testIterHasNext", testIterHasNext(iterAfterNext(scenario.build(), 3), Result.False));
			printTest(scenarioName + "_iter3xNext_testIterNext", testIterNext(iterAfterNext(scenario.build(), 3), null, Result.NoSuchElement));
			printTest(scenarioName + "_iter3xNext_testIterRemove", testIterRemove(iterAfterNext(scenario.build(), 3), Result.NoException));
			printTest(scenarioName + "_iter3xNextRemove_testIterRemove", testIterRemove(iterAfterRemove(iterAfterNext(scenario.build(), 3)), Result.IllegalState));
			printTest(scenarioName + "_iter3xNextRemove_testIterHasNext", testIterHasNext(iterAfterRemove(iterAfterNext(scenario.build(), 3)), Result.False));
			printTest(scenarioName + "_iter3xNextRemove_testIterNext", testIterNext(iterAfterRemove(iterAfterNext(scenario.build(), 3)), null, Result.NoSuchElement));
